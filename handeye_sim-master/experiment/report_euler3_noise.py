...
if __name__ == '__main__':
    ...
    x_range = np.arange(0.0, 0.01+0.002, 0.002)
    ...
    # f2_ax2 = fig1.add_subplot(spec2[0, 1])
    # f2_ax3 = fig1.add_subplot(spec2[0, 2])
    # f2_ax4 = fig1.add_subplot(spec2[1, 0])
    # f2_ax5 = fig1.add_subplot(spec2[1, 1])
    # f2_ax6 = fig1.add_subplot(spec2[1, 2])
    ...
    plt.savefig(os.path.join(root_dir,"Ecamera2end_noise.png"))
    plt.show()
    ...
    plt.savefig(os.path.join(root_dir, "Eobj2base_noise.png"))
    plt.show()
