...
IMAGE_NAME = 'images/Color_r_000.png'
PARA_SAVE_PATH = "parameters/parameters_right.yaml"
...
objp = np.zeros((9*6,3), np.float32)*0.024
objp[:,:2] = np.mgrid[0:9,0:6].T.reshape(-1,2)*0.024
