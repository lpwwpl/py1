...
from Extensions.Settings.ColorScheme.Lexers import AsLexer
...
class StyleLexer(QtWidgets.QWidget):
    ...
    def updatePropertyListWidget(self, groupName):
        if groupName == "Python":
            ...
            styles = AsLexer.styleDescriptions()
    ...
    def createLexer(self, paper, style_name, groupName):
        ...
        if groupName == "Python":
            ...
            lexer = AsLexer.AsLexer(style, paper)
        return lexer
