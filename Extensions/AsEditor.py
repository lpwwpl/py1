...
#        self.setAnnotationDisplay(QsciScintilla.AnnotationStandard)
        ...
        # self.setMarginSensitivity(1, True) #设置是否可以显示断点
        # self.setMarginsBackgroundColor(QtGui.QColor("#bbfaae"))
        # self.setMarginMarkerMask(1, 0x02)
        # self.markerDefine(QsciScintilla.Circle, 1)
        # self.setMarkerBackgroundColor(QtGui.QColor("#ee1111"), 1)
    ...
    def mouseReleaseEvent(self, event):
        self.middleMousePressed = False
        super(AsEditor, self).mouseReleaseEvent(event)
    ...
    def mousePressEvent(self, event):
        ...
        super(AsEditor, self).mousePressEvent(event)
    ...
    def mouseMoveEvent(self, event):
        ...
        super(AsEditor, self).mouseMoveEvent(event)
