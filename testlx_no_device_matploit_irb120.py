...
from environment_pick_place_irb120 import *
import pdb
import threading
import kdata_lx
...
class KCore(QtCore.QThread):
    ...
    def text_read(self):
        ...
        if kdata_lx.isVirt:
            ...
            #                [0, -1, 0,0],
            #                [0, 0, -1, 0.05], [0, 0, 0, 1]]
            Cam2Base_rm = [[ 9.96597953e-01 , 2.78533048e-02 , 7.75674800e-02, -0.118077843],
                         [-3.32816281e-02,  9.97020186e-01,  6.95922482e-02 , 0.0316021443],
                         [-7.53979693e-02, -7.19370641e-02,  9.94555280e-01, -0.0480187550],
                         [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00 , 1.00000000e+00]]
    ...
    def Fun_Eyeinhand_Shooting(self,flag):
        if flag == False:
            ...
            # print(a)
            Tool2Base_Shooting = [0.55717, -0.100, 0.38010000000000003 ,3.141592653589793, 0, 0]
    ...
    def     Fun_Eyeinhand_Release(self,flag):
        ...
        z = 0
        if flag == False:
            Tool2Base_Release = [(0.20 + 0.12 * x) , (-0.2 + 0.08 * y) , (0.275 + 0.05 * z) ,
...
class Kawasaki_lx(QWidget):
    ...
    def initUI(self):
        ...
        self.env = Environment_Pick_Place_irb120()
