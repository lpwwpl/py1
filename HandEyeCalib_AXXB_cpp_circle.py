...
if __name__ == '__main__':
    ...
    # cameraMatrix=np.asarray([606.069580078125, 0.0, 327.31475830078125],
    #                         [0.0, 606.164794921875, 242.045166015625],
    #                         [0.0, 0.0, 1.0])

    # criteria = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, 30, 0.001)
    criteria = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_COUNT, 30, 2.2204460492503131e-016)
    ...
    for i in range(h_size):
        for j in range(w_size):
            x = i * CheckerboardSquareSize
            y = j * CheckerboardSquareSize
            z = 0
            objp[i * h_size + j] = np.asarray([x, y, z])
    ...
    for j in range(len(robotrvecs)):
        ...
        robottvecs[j] = t
        # mat = r_t_to_mat(r, t)
        # gripper2base.append(mat)
    print("rvecs: ", rvecs)
    print("tvecs:", tvecs)
    print("robotrvecs: ", robotrvecs)
    print("robottvecs:", robottvecs)
